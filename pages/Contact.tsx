...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await supabaseDb.messages.add(formData);
          ...
          <Card className="p-8 h-fit lg:col-span-1 border-t-4 border-blue-500">
            ...
            <div className="mt-10 pt-6 border-t">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-blue-400 hover:text-white transition-colors"
                >
                  <Twitter size={18} />
                </a>
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-pink-600 hover:text-white transition-colors"
                >
                  <Instagram size={18} />
                </a>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === "error" && (
                  <div className="bg-red-50 text-red-600 p-3 rounded flex items-center text-sm">
                    <AlertCircle size={16} className="mr-2" /> Failed to send
