...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "uppercase font-medium tracking-wide rounded transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-1";
  ...
  const variants = {
    contained: {
      primary:
        "bg-blue-600 text-white hover:bg-blue-700 shadow-md hover:shadow-lg active:shadow-none disabled:bg-blue-300",
      secondary:
        "bg-pink-600 text-white hover:bg-pink-700 shadow-md hover:shadow-lg disabled:bg-pink-300",
      danger:
        "bg-red-600 text-white hover:bg-red-700 shadow-md hover:shadow-lg disabled:bg-red-300",
    },
    outlined: {
      primary:
  ...
  return (
    <button
      className={`${baseStyles} ${sizeClass} ${styleClass} ${widthClass} ${className}`}
...
export const TextField: React.FC<InputProps> = ({
  ...
  const inputStyles =
    "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors bg-white text-gray-900 placeholder-gray-400";
